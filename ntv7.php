...
$sql1 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE  '.$resp2.'  type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Test" AND urgency = "low" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) <=2) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql2 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE  '.$resp2.' type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Test" AND urgency = "low" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) >2) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql3 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Test" AND urgency = "medium" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) <=1) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql4 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Test" AND urgency = "medium" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) >1) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql5 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Test" AND urgency = "high" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (TIME_TO_SEC(TIMEDIFF( owned_date, created_date)) <=14400) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql6 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE  '.$resp2.'  type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Test" AND urgency = "high" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (TIME_TO_SEC(TIMEDIFF( owned_date, created_date)) >14400) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';

//Environnement TRAIN
$sql7 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'    type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Training" AND urgency = "low" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) <=2) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql8 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Training" AND urgency = "low" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) >2) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql9 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Training" AND urgency = "medium" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) <=1) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql10 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Training" AND urgency = "medium" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) >1) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql11 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Training" AND urgency = "high" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (TIME_TO_SEC(TIMEDIFF( owned_date, created_date)) <=14400)  AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql12 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Training" AND urgency = "high" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (TIME_TO_SEC(TIMEDIFF( owned_date, created_date)) >14400) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';

//Environnement PROD
$sql13 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Production" AND urgency = "low" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) <=2) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql14 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Production" AND urgency = "low" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) >2) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql15 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE  '.$resp2.'  type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Production" AND urgency = "medium" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) <=1) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql16 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Production" AND urgency = "medium" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (datediff( owned_date, created_date) >1) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
$sql17 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.'   type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Production" AND urgency = "high" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and (TIME_TO_SEC(TIMEDIFF( owned_date, created_date)) <=14400) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
...
// Setup graph title
$graph->title->Set($valeur.' OPEN INCS TTI   BETWEEN '.$date1.' AND '.$date2);
...
$b2plot->SetLegend('TTI : KO   L > 2j     M > 1j     H > 4h');
