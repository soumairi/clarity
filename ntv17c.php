...
for($b=1; $b<= $nbre; $b++)
		...
		$sql50 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
				...
				$sql5 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql6 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql7 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql8 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql9 .=' urgency = "Low" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "SKYSCHEDULE"  OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion="SKYPORT" OR AppVersion=" " ) AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				...
				$sql25 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql26 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql27 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql28 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql29 .=' urgency = "Medium" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "SKYSCHEDULE"  OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="SKYPORT"  OR AppVersion="Network") AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				...
				$sql35 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql36 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql37 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql38 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql39 .=' urgency = "High" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "SKYSCHEDULE"  OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="SKYPORT" ) AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				...
				$sql45 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql46 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql47 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql48 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production" AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('NTV - NSK APP REPARTITION IN RESOLVED PRODUCTION INCIDENTS  BETWEEN 201'.$annee.'-'.$mois.'-01 AND 201'.$i.'-'.$k  .'-31');
...
$b1plot->SetLegend('EAI NOTIFICATION');
$b2plot->SetLegend('STANDARD NOTIF');
$b3plot->SetLegend('API');
$b4plot->SetLegend('SKYPAY');
$b5plot->SetLegend('SKYSALES');
$b6plot->SetLegend('SKYSPEED');
$b7plot->SetLegend('SKYREPORT');
