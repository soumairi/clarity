...
$sql1 = 'SELECT tracking_id, short_description, urgency, impacted_account,created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0))as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "low" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Production" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >15' ;
$sql2 = 'SELECT tracking_id, short_description, urgency, impacted_account, created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "medium" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Production" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >10' ;
$sql3 = 'SELECT tracking_id, short_description, urgency, impacted_account, created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "high" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Production" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >5' ;

//Environnement de TRAIN

$sql4 = 'SELECT tracking_id, short_description, urgency, impacted_account,created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0))as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "low" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Training" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >15' ;
$sql5 = 'SELECT tracking_id, short_description, urgency, impacted_account, created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "medium" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Training" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >10' ;
$sql6 = 'SELECT tracking_id, short_description, urgency, impacted_account, created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "high" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Training" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >5' ;

//Environnement de TEST

$sql7 = 'SELECT tracking_id, short_description, urgency, impacted_account,created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0))as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "low" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Test" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >15' ;
$sql8 = 'SELECT tracking_id, short_description, urgency, impacted_account, created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "medium" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Test" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >10' ;
$sql9 = 'SELECT tracking_id, short_description, urgency, impacted_account, created_date, resolution_date, (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE '.$resp2.' urgency = "high" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.'" AND category = "'.$valeur.'" AND impacted_account = "Test" AND type="incident" AND (datediff( resolution_date, created_date) - (WEEK(resolution_date) - WEEK(created_date))* 2 - IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0)) >5' ;
