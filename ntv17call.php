...
for($b=1; $b<= $nbre; $b++)
		...
		$sql50 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
				...
				$sql1 .=' urgency = "Low"    AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low"    AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql4 .=' urgency = "Low"    AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql5 .=' urgency = "Low"    AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql6 .=' urgency = "Low"    AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql7 .=' urgency = "Low"    AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql8 .=' urgency = "Low"    AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				...
				$sql10 .=' urgency = "Low"   AND category = "NTV - YMS" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql21 .=' urgency = "Medium"    AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql23 .=' urgency = "Medium"    AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql24 .=' urgency = "Medium"    AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql25 .=' urgency = "Medium"    AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql26 .=' urgency = "Medium"    AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql27 .=' urgency = "Medium"    AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql28 .=' urgency = "Medium"    AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql29 .=' urgency = "Medium"    AND (AppVersion= "Epic" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="Au Update files" OR AppVersion="RFFE Files" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql30 .=' urgency = "Medium"   AND category = "NTV - YMS" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql31 .=' urgency = "High"    AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql33 .=' urgency = "High"    AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql34 .=' urgency = "High"    AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql35 .=' urgency = "High"    AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql36 .=' urgency = "High"    AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql37 .=' urgency = "High"    AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql38 .=' urgency = "High"    AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql39 .=' urgency = "High"    AND (AppVersion= "Epic" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="Au Update files" OR AppVersion="RFFE Files" OR AppVersion=" " ) AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql40 .=' urgency = "High"   AND category = "NTV - YMS" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql41 .=' urgency = "Critical"    AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql43 .=' urgency = "Critical"    AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql44 .=' urgency = "Critical"    AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql45 .=' urgency = "Critical"    AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql46 .=' urgency = "Critical"    AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql47 .=' urgency = "Critical"    AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql48 .=' urgency = "Critical"    AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql49 .=' urgency = "Critical"    AND (AppVersion= "Epic" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="Au Update files" OR AppVersion="RFFE Files" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql50 .=' urgency = "Critical"   AND category = "NTV - YMS" AND impacted_account = "Production" AND (type = "Service Request" OR type = "Information Request")  AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				//echo $sql41.'<br>';
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('NTV - NSK APP REPARTITION IN RESOLVED PRODUCTION REQUESTS  BETWEEN 201'.$annee.'-'.$mois.'-01 AND 201'.$i.'-'.$k  .'-31');
