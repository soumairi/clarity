...
for($b=1; $b<= $nbre; $b++)
		...
		$sql50 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
				...
				$sql1 .=' urgency = "Low" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI NOTIFICATION") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql4 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql5 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql6 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql7 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql8 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				...
				$sql10 .=' urgency = "Low" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				
				$sql21 .=' urgency = "Medium" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI NOTIFICATION") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql23 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql24 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql25 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql26 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql27 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql28 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				...
				$sql30 .=' urgency = "Medium" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				
				$sql31 .=' urgency = "High" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI NOTIFICATION") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql33 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql34 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql35 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql36 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql37 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql38 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql39 .=' urgency = "High" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "SKYSCHEDULE"  OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="SKYPORT") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql40 .=' urgency = "High" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				
				$sql41 .=' urgency = "Critical" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI NOTIFICATION") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql43 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql44 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql45 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql46 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql47 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql48 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql49 .=' urgency = "Critical" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "SKYSCHEDULE"  OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="SKYPORT" OR AppVersion="Network") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql50 .=' urgency = "Critical" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31 23:59:00"' ;
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('NTV - NSK  APP REPARTITION IN PRODUCTION INCIDENTS CREATED SINCE 201'.$annee.'-'.$mois.'-01 AND 201'.$i.'-'.$k  .'-31');
...
$b2plot->SetLegend('STANDARD NOTIFS');
