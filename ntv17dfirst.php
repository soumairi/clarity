...
for($i=$annee; $i<= $annee2; $i++)
		...
		$sql50 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
							if ($mois2 <= 9 )
							{
								for ($j=$mois; $j <= $mois2 ; $j++ )
									{
				$sql1 .=' urgency = "Low" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql4 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql5 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql6 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql7 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql8 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql9 .=' urgency = "Low" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="AU Update Files" OR AppVersion="RFFE Files" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql10 .=' urgency = "Low" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql21 .=' urgency = "Medium" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql23 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql24 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql25 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql26 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql27 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql28 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql29 .=' urgency = "Medium" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="AU Update Files" OR AppVersion="RFFE Files" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql30 .=' urgency = "Medium" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql31 .=' urgency = "High" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql33 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql34 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql35 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql36 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql37 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql38 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql39 .=' urgency = "High" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="AU Update Files" OR AppVersion="RFFE Files" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql40 .=' urgency = "High" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql41 .=' urgency = "Critical" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql43 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql44 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql45 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql46 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql47 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql48 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql49 .=' urgency = "Critical" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="AU Update Files" OR AppVersion="RFFE Files" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql50 .=' urgency = "Critical" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-0'.$j.'-01" AND created_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
		...
		$sql50 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
								...
								for ($j=10; $j <= $mois2; $j++ )
									{
									$sql1 .=' urgency = "Low" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql4 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql5 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql6 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql7 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql8 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql9 .=' urgency = "Low" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="AU Update Files" OR AppVersion="RFFE Files" OR AppVersion=" " ) AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql10 .=' urgency = "Low" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
								
				$sql21 .=' urgency = "High" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql23 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql24 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql25 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql26 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql27 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql28 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql29 .=' urgency = "Medium" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="AU Update Files" OR AppVersion="RFFE Files"OR AppVersion=" " ) AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql30 .=' urgency = "Medium" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				
				$sql31 .=' urgency = "High" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql33 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql34 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql35 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql36 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql37 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql38 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql39 .=' urgency = "High" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="AU Update Files" OR AppVersion="RFFE Files" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql40 .=' urgency = "High" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				
				$sql41 .=' urgency = "Critical" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI notification") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql43 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql44 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql45 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Sky Pay" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql46 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Sky Sales" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql47 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Sky Speed" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql48 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Sky Report" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql49 .=' urgency = "Critical" AND type = "Incident"  AND (AppVersion= "EPIC Services" OR AppVersion= "Data Bases (ODS, OLTP)" OR AppVersion="Sky Utilities" OR AppVersion="AU Update Files" OR AppVersion="RFFE Files" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
				$sql50 .=' urgency = "Critical" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date >="201'.$i.'-'.$j.'-01" AND created_date <="201'.$i.'-'.$j.'-31"' ;
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('NTV - NSK  APP REPARTITION IN PRODUCTION INCIDENTS CREATED BETWEEN '.$date1.' AND '.$date2);
