...
for($b=1; $b<= $nbre; $b++)
		...
		$sql45 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  status <> "Rejected" AND '.$resp2.'  ';
				...
				$sql1 .=' urgency = "Low" '.$type1.'  AND AppVersion= "NETWORK"  AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'  AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low" '.$type1.'  AND AppVersion= "PAO"  AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'  AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql4 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SIDH" AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'  AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql5 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SQILLS" AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'  AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;

				
				$sql21 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "NETWORK"  AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql23 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "PAO"  AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql24 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SIDH" AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql25 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SQILLS" AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;

				
				$sql31 .=' urgency = "High" '.$type1.'  AND AppVersion= "NETWORK"  AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql33 .=' urgency = "High" '.$type1.'  AND AppVersion= "PAO"  AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql34 .=' urgency = "High" '.$type1.'  AND AppVersion= "SIDH" AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql35 .=' urgency = "High" '.$type1.'  AND AppVersion= "SQILLS" AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;

				
				$sql41 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "NETWORK"  AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql43 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "PAO"  AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql44 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SIDH" AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
				$sql45 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SQILLS" AND (category = "EUROSTAR - PAO" OR category = "EUROSTAR-SIDH") '.$plat1.'   AND created_date >="20'.$i.'-'.$j.'-01" AND created_date <="20'.$i.'-'.$j.'-31 23:59:00"' ;
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('EIL   APP REPARTITION IN PRODUCTION INCIDENTS CREATED SINCE 20'.$annee.'-'.$mois.'-01 AND 20'.$i.'-'.$k  .'-31');
