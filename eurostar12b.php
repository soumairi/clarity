...
$sql1 = 'SELECT tracking_id, short_description, urgency, category, impacted_account,created_date, resolution_date, start_bounced_time, end_bounced_time, (datediff( resolution_date, created_date) - IFNULL((datediff(end_bounced_time, start_bounced_time) ),0))as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE  '.$resp2.'  urgency = "low" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.' 23:59:00" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") AND impacted_account = "Production" AND type="incident" order by month(resolution_date)' ;

$sql2 = 'SELECT tracking_id, short_description, category, urgency, impacted_account, created_date, resolution_date, start_bounced_time, end_bounced_time, (datediff( resolution_date, created_date) - IFNULL((datediff(end_bounced_time, start_bounced_time) ),0)) as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE  '.$resp2.'  urgency = "medium" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.' 23:59:00" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") AND impacted_account = "Production" AND type="incident" order by month(resolution_date)' ;

$sql3 = 'SELECT tracking_id, short_description, category, urgency, impacted_account, created_date, resolution_date, start_bounced_time, end_bounced_time, (datediff( resolution_date, created_date) - IFNULL((datediff(end_bounced_time, start_bounced_time) ),0)) as numb, IFNULL((datediff(end_bounced_time, start_bounced_time) - (WEEK(end_bounced_time) - WEEK(start_bounced_time))*2),0) as bounced from data WHERE  '.$resp2.'  urgency = "high" AND resolution_date >="'.$date1.'" AND resolution_date <="'.$date2.' 23:59:00" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL")  AND impacted_account = "Production" AND type="incident" order by month(resolution_date)' ;
