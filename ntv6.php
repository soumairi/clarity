...
$sql5 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE  '.$resp2.' type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Test" AND urgency = "high" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and ((datediff( current_date, created_date) - (WEEK(current_date) - WEEK(created_date))* 2)  <=5) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
...
$sql11 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE '.$resp2.' type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Training" AND urgency = "high" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and ((datediff( current_date, created_date) - (WEEK(current_date) - WEEK(created_date))* 2) <=5) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
...
$sql17 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE  '.$resp2.' type = "Incident" AND category = "'.$valeur.'" AND impacted_account = "Production" AND urgency = "high" AND (status = "Owned" OR status = "New" OR status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) and ((datediff( current_date, created_date) - (WEEK(current_date) - WEEK(created_date))* 2) <=5) AND created_date >= "'.$date1.'" AND created_date<= "'.$date2.'"';
...
// Setup graph title
$graph->title->Set($valeur.' OPEN INCS TTR  BETWEEN '.$date1.' AND '.$date2);
...
$b2plot->SetLegend('TTR : KO   L > 15j     M > 10j     H > 5j');
