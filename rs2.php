...
$sql1 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "low" AND status = "New" AND created_date >= "'.$date1.'"';
$sql2 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "low" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql3 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "low" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';

$sql4 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "medium" AND status = "New" AND created_date >= "'.$date1.'"';
$sql5 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "medium" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql6 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "medium" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';

$sql7 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "high" AND status = "New" AND created_date >= "'.$date1.'"';
$sql8 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "high" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql9 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Test" AND urgency = "high" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';

//Environnement TRAIN
$sql10 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "low" AND status = "New" AND created_date >= "'.$date1.'"';
$sql11 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "low" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql12 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "low" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';

$sql13 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "medium" AND status = "New" AND created_date >= "'.$date1.'"';
$sql14 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "medium" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql15 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "medium" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';

$sql16 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "high" AND status = "New" AND created_date >= "'.$date1.'"';
$sql17 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "high" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql18 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Training" AND urgency = "high" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';

//Environnement PROD
$sql19 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "low" AND status = "New" AND created_date >= "'.$date1.'"';
$sql20 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "low" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql21 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "low" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';

$sql22 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "medium" AND status = "New" AND created_date >= "'.$date1.'"';
$sql23 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "medium" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql24 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "medium" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';

$sql25 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "high" AND status = "New" AND created_date >= "'.$date1.'"';
$sql26 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "high" AND status = "Owned" AND created_date >= "'.$date1.'"';
$sql27 = 'SELECT COUNT(tracking_id) as numb FROM data  WHERE   impacted_account = "Production" AND urgency = "high" AND (status = "Bounced For Clarification" OR status = "Work In Progress" OR status = "Escalated" ) AND created_date >= "'.$date1.'"';
...
// Setup graph title
$graph->title->Set('Répartition des INCS ouverts RS_OS depuis le '.$date1);
