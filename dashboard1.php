<html>
	  ...
	  <div id="container">
		...
		<h1>DASHBOARD Laurent&nbsp;&nbsp; <img src="img/picto1.jpg" align=bottom border=0></h1><br><br>
		...
		Responsabilité côté RS: OUI<input type="radio" name="site" value="1"> NON <input type="radio" name="site" value="0"> <br><br>
