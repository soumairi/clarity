...
for($b=1; $b<= $nbre; $b++)
		...
		$sql50 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
				...
				$sql1 .=' urgency = "Low" '.$type1.'  AND (AppVersion = "RMF NSK" OR AppVersion = "RMF Extract" OR AppVersion= "RMF RENFE" OR AppVersion="RMF SVSI" OR AppVersion= "RMF UIC") AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - RMF") '.$plat1.'   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low" '.$type1.'  AND AppVersion= "DATA BASE (ODS, OLTP)"  AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql4 .=' urgency = "Low" '.$type1.'  AND AppVersion= "API" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql5 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SKYSCHEDULED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql6 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SKYUTILITIES" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql7 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SKYSPEED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql8 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SKYREPORT" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql9 .=' urgency = "Low" '.$type1.'  AND (AppVersion= "EPIC Services" OR AppVersion= "Clarity PPM"  OR AppVersion= "Standard Notification"  OR AppVersion="Network" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="RR-TANGO" OR AppVersion="RESA RAIL") AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql10 .=' urgency = "Low" '.$type1.' AND (category = "ELIPSOS - YMS" OR category="CORM - YMS") '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				
				$sql21 .=' urgency = "Medium" '.$type1.'  AND (AppVersion = "RMF NSK" OR AppVersion = "RMF Extract" OR AppVersion= "RMF RENFE" OR AppVersion="RMF SVSI" OR AppVersion= "RMF UIC") AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - RMF") '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql23 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "DATA BASE (ODS, OLTP)"  AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql24 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "API" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql25 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SKYSCHEDULED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql26 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SKYUTILITIES" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql27 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SKYSPEED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql28 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SKYREPORT" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql29 .=' urgency = "Medium" '.$type1.'  AND (AppVersion= "EPIC Services" OR AppVersion= "Clarity PPM"  OR AppVersion= "Standard Notification"  OR AppVersion="Network" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="RR-TANGO" OR AppVersion="RESA RAIL") AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql30 .=' urgency = "Medium" '.$type1.' AND (category = "ELIPSOS - YMS" OR category="CORM - YMS") '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				
				$sql31 .=' urgency = "High" '.$type1.'  AND (AppVersion = "RMF NSK" OR AppVersion = "RMF Extract" OR AppVersion= "RMF RENFE" OR AppVersion="RMF SVSI" OR AppVersion= "RMF UIC") AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - RMF") '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql33 .=' urgency = "High" '.$type1.'  AND AppVersion= "DATA BASE (ODS, OLTP)"  AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql34 .=' urgency = "High" '.$type1.'  AND AppVersion= "API" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql35 .=' urgency = "High" '.$type1.'  AND AppVersion= "SKYSCHEDULED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql36 .=' urgency = "High" '.$type1.'  AND AppVersion= "SKYUTILITIES" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql37 .=' urgency = "High" '.$type1.'  AND AppVersion= "SKYSPEED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql38 .=' urgency = "High" '.$type1.'  AND AppVersion= "SKYREPORT" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql39 .=' urgency = "High" '.$type1.'  AND (AppVersion= "EPIC Services" OR AppVersion= "Clarity PPM"  OR AppVersion= "Standard Notification"  OR AppVersion="Network" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="RR-TANGO" OR AppVersion="RESA RAIL") AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql40 .=' urgency = "High" '.$type1.' AND (category = "ELIPSOS - YMS" OR category="CORM - YMS") '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				
				$sql41 .=' urgency = "Critical" '.$type1.'  AND (AppVersion = "RMF NSK" OR AppVersion = "RMF Extract" OR AppVersion= "RMF RENFE" OR AppVersion="RMF SVSI" OR AppVersion= "RMF UIC") AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - RMF") '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql43 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "DATA BASE (ODS, OLTP)"  AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql44 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "API" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql45 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SKYSCHEDULED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql46 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SKYUTILITIES" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql47 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SKYSPEED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql48 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SKYREPORT" AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql49 .=' urgency = "Critical" '.$type1.'  AND (AppVersion= "EPIC Services" OR AppVersion= "Clarity PPM"  OR AppVersion= "Standard Notification"  OR AppVersion="Network" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="RR-TANGO" OR AppVersion="RESA RAIL") AND category = "ELIPSOS - NSK" '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql50 .=' urgency = "Critical" '.$type1.' AND (category = "ELIPSOS - YMS" OR category="CORM - YMS") '.$plat1.'   AND created_date <"20'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"20'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('ELIPSOS   APP REPARTITION IN PRODUCTION INCIDENTS STILL OPENED SINCE 20'.$annee.'-'.$mois.'-01 AND 20'.$i.'-'.$k  .'-31');
