...
for($b=1; $b<= $nbre; $b++)
		...
		$sql50 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
				...
				$sql1 .=' urgency = "Low" '.$type1.'  AND (AppVersion = "RMF NSK" OR AppVersion = "RMF Extract" OR AppVersion= "RMF RENFE" OR AppVersion="RMF SVSI" OR AppVersion= "RMF UIC") AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - RMF") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low" '.$type1.'  AND AppVersion= "DATA BASE (ODS, OLTP)"  AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql4 .=' urgency = "Low" '.$type1.'  AND AppVersion= "API" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql5 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SKYSCHEDULE" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql6 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SKYUTILITIES" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql7 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SKYSPEED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql8 .=' urgency = "Low" '.$type1.'  AND AppVersion= "SKYREPORT" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql9 .=' urgency = "Low" '.$type1.'  AND (AppVersion= "EPIC Services" OR AppVersion= "Clarity PPM"  OR AppVersion= "Standard Notification"  OR AppVersion="Network" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="RR-TANGO" OR AppVersion="RESA RAIL") AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql10 .=' urgency = "Low" '.$type1.' AND (category = "ELIPSOS - YMS" OR category="CORM - YMS") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql21 .=' urgency = "Medium" '.$type1.'  AND (AppVersion = "RMF NSK" OR AppVersion = "RMF Extract" OR AppVersion= "RMF RENFE" OR AppVersion="RMF SVSI" OR AppVersion= "RMF UIC") AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - RMF") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql23 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "DATA BASE (ODS, OLTP)"  AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql24 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "API" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql25 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SKYSCHEDULE" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql26 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SKYUTILITIES" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql27 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SKYSPEED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql28 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "SKYREPORT" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql29 .=' urgency = "Medium" '.$type1.'  AND (AppVersion= "EPIC Services" OR AppVersion= "Clarity PPM"  OR AppVersion= "Standard Notification"  OR AppVersion="Network" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="RR-TANGO" OR AppVersion="RESA RAIL") AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql30 .=' urgency = "Medium" '.$type1.' AND (category = "ELIPSOS - YMS" OR category="CORM - YMS") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql31 .=' urgency = "High" '.$type1.'  AND (AppVersion = "RMF NSK" OR AppVersion = "RMF Extract" OR AppVersion= "RMF RENFE" OR AppVersion="RMF SVSI" OR AppVersion= "RMF UIC") AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - RMF") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql33 .=' urgency = "High" '.$type1.'  AND AppVersion= "DATA BASE (ODS, OLTP)"  AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql34 .=' urgency = "High" '.$type1.'  AND AppVersion= "API" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql35 .=' urgency = "High" '.$type1.'  AND AppVersion= "SKYSCHEDULE" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql36 .=' urgency = "High" '.$type1.'  AND AppVersion= "SKYUTILITIES" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql37 .=' urgency = "High" '.$type1.'  AND AppVersion= "SKYSPEED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql38 .=' urgency = "High" '.$type1.'  AND AppVersion= "SKYREPORT" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql39 .=' urgency = "High" '.$type1.'  AND (AppVersion= "EPIC Services" OR AppVersion= "Clarity PPM"  OR AppVersion= "Standard Notification"  OR AppVersion="Network" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="RR-TANGO" OR AppVersion="RESA RAIL") AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql40 .=' urgency = "High" '.$type1.' AND (category = "ELIPSOS - YMS" OR category="CORM - YMS") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				$sql41 .=' urgency = "Critical" '.$type1.'  AND (AppVersion = "RMF NSK" OR AppVersion = "RMF Extract" OR AppVersion= "RMF RENFE" OR AppVersion="RMF SVSI" OR AppVersion= "RMF UIC") AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - RMF") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql43 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "DATA BASE (ODS, OLTP)"  AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql44 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "API" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql45 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SKYSCHEDULE" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql46 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SKYUTILITIES" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql47 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SKYSPEED" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql48 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "SKYREPORT" AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql49 .=' urgency = "Critical" '.$type1.'  AND (AppVersion= "EPIC Services" OR AppVersion= "Clarity PPM"  OR AppVersion= "Standard Notification"  OR AppVersion="Network" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="RR-TANGO" OR AppVersion="RESA RAIL") AND category = "ELIPSOS - NSK" '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql50 .=' urgency = "Critical" '.$type1.' AND (category = "ELIPSOS - YMS" OR category="CORM - YMS") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="20'.$i.'-0'.$j.'-01" AND resolution_date <="20'.$i.'-0'.$j.'-31 23:59:00"' ;
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('ELIPSOS   APP REPARTITION IN PRODUCTION INCIDENTS RESOLVED SINCE 20'.$annee.'-'.$mois.'-01 AND 20'.$i.'-'.$k  .'-31');
...
$b1plot->SetLegend('RMF');
$b2plot->SetLegend('DATA BASE (ODS, OLTP)');
$b3plot->SetLegend('API');
$b4plot->SetLegend('SKYSCHEDULE');
$b5plot->SetLegend('SKYUTILITIES');
