<html>
	  ...
	  <div id="container">
		...
		<h1>DASHBOARD BENE PAO&nbsp;&nbsp; <img src="img/picto1.jpg" align=bottom border=0></h1><br><br>
		
		<FORM Method="GET" Action="benePAO.php">
			...
			<?php $date3 = strftime("%Y-%m-%d", mktime(0, 0, 0, date('m'), date('d')-1, date('y'))); ?>
				...
				A partir de quelle date : <SELECT name="mois" size="1">
									...
									<br><br>
		Nombre de mois a visualiser: <SELECT name="nbre" size="1">
		...
		Responsabilite cote RS: OUI<input type="radio" name="site" value="1"> NON <input type="radio" name="site" value="0"> <br><br>
