...
?>
 <body>
	  <div id="container">
		...
		<a href="thalys17db.php?mois=<?php echo $mois;?>&annee=<?php echo $annee;?>&site=<?php echo $resp;?>&valeur=<?php echo $valeur;?>&nbre=<?php echo $nbre;?>" border=0 alt="thalys12list.php">Détail des Incidents créés</a></br></br>
		...
		<a href="thalys17cb.php?mois=<?php echo $mois;?>&annee=<?php echo $annee;?>&site=<?php echo $resp;?>&valeur=<?php echo $valeur;?>&nbre=<?php echo $nbre;?>" border=0 alt="thalys12list.php">Détail des Incidents résolus</a></br></br>
		...
		<a href="thalys17eb2.php?mois=<?php echo $mois;?>&annee=<?php echo $annee;?>&site=<?php echo $resp;?>&valeur=<?php echo $valeur;?>&nbre=<?php echo $nbre;?>" border=0 alt="thalys12list.php">Détail des Incidents encore ouverts</a></br></br>
		...
		<a href="thalys20b.php?mois=<?php echo $mois;?>&annee=<?php echo $annee;?>&site=<?php echo $resp;?>&valeur=<?php echo $valeur;?>&nbre=<?php echo $nbre;?>" border=0 alt="thalys12list.php">Détail de la répartition de la responsabilité</a></br></br>
		...
		<a href="thalys12b.php?mois=<?php echo $mois;?>&annee=<?php echo $annee;?>&site=<?php echo $resp;?>&valeur=<?php echo $valeur;?>&nbre=<?php echo $nbre;?>" border=0 alt="thalys12list.php">Détail durée de vie des Incidents</a></br></br>
