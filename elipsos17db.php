...
?>
<center>
<br><a href="#" onclick="$('#example1').table2CSV({header:['ID', 'Provider ID', 'Status', 'Type', 'Titre','Category', 'Criticité', 'App Version', 'Creation Date']})">Exporter en CSV </a><br><br>
