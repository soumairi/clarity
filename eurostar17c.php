...
for($b=1; $b<= $nbre; $b++)
		...
		$sql49 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
				...
				$sql1 .=' urgency = "Low" '.$type1.'  AND AppVersion= "NETWORK"  AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low" '.$type1.'  AND AppVersion= "EDCS"  AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql4 .=' urgency = "Low" '.$type1.'  AND AppVersion= "OASSIS" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql5 .=' urgency = "Low" '.$type1.'  AND AppVersion= "RR-GDS3" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql6 .=' urgency = "Low" '.$type1.'  AND AppVersion= "RR-SWAY" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql7 .=' urgency = "Low" '.$type1.'  AND AppVersion= "ELGAR" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql8 .=' urgency = "Low" '.$type1.'  AND AppVersion= "RESA RAIL" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql9 .=' urgency = "Low" '.$type1.'  AND AppVersion= "PNI-IND" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				
				$sql21 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "NETWORK"  AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql23 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "EDCS"  AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql24 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "OASSIS" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql25 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "RR-GDS3" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql26 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "RR-SWAY" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql27 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "ELGAR" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql28 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "RESA RAIL" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql29 .=' urgency = "Medium" '.$type1.'  AND AppVersion= "PNI-IND" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				
				$sql31 .=' urgency = "High" '.$type1.'  AND AppVersion= "NETWORK"  AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql33 .=' urgency = "High" '.$type1.'  AND AppVersion= "EDCS"  AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql34 .=' urgency = "High" '.$type1.'  AND AppVersion= "OASSIS" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql35 .=' urgency = "High" '.$type1.'  AND AppVersion= "RR-GDS3" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql36 .=' urgency = "High" '.$type1.'  AND AppVersion= "RR-SWAY" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql37 .=' urgency = "High" '.$type1.'  AND AppVersion= "ELGAR" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql38 .=' urgency = "High" '.$type1.'  AND AppVersion= "RESA RAIL" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql39 .=' urgency = "High" '.$type1.'  AND AppVersion= "PNI-IND" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				
				
				$sql41 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "NETWORK"  AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql43 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "EDCS"  AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql44 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "OASSIS" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql45 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "RR-GDS3" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql46 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "RR-SWAY" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql47 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "ELGAR" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql48 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "RESA RAIL" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
				$sql49 .=' urgency = "Critical" '.$type1.'  AND AppVersion= "PNI-IND" AND (category = "EIL-HOSTING" or category = "EIL-RESARAIL") '.$plat1.'   AND (status = "Resolved" OR status = "Temporary Resolved" OR status = "Closed" ) AND resolution_date >="201'.$i.'-0'.$j.'-01" AND resolution_date <="201'.$i.'-0'.$j.'-31 23:59:00"' ;
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('EIL   APP REPARTITION IN PRODUCTION INCIDENTS RESOLVED SINCE 201'.$annee.'-'.$mois.'-01 AND 201'.$i.'-'.$k  .'-31');
