...
$sql1 = 'SELECT tracking_id, short_description, urgency, Provider_id, status, category, impacted_account, type, created_date, AppVersion  from data WHERE  '.$resp2.'  urgency = "low" AND created_date <"'.$date2.' 23:59:00" AND (resolution_date >"'.$date2.' 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected" AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - YMS" OR category = "CORM - YMS" OR category = "ELIPSOS - RMF") '.$plat1.' '.$type1.' order by month(resolution_date)' ;
$sql2 = 'SELECT tracking_id, short_description, urgency, Provider_id, status, category, impacted_account, type, created_date, AppVersion  from data WHERE  '.$resp2.'  urgency = "MEDIUM" AND created_date <"'.$date2.' 23:59:00" AND (resolution_date >"'.$date2.' 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected" AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - YMS" OR category = "CORM - YMS" OR category = "ELIPSOS - RMF") '.$plat1.' '.$type1.' order by month(resolution_date)' ;
$sql3 = 'SELECT tracking_id, short_description, urgency, Provider_id, status, category, impacted_account, type, created_date, AppVersion  from data WHERE  '.$resp2.'  urgency = "HIGH" AND created_date <"'.$date2.' 23:59:00" AND (resolution_date >"'.$date2.' 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected" AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - YMS" OR category = "CORM - YMS" OR category = "ELIPSOS - RMF") '.$plat1.' '.$type1.' order by month(resolution_date)' ;
$sql4 = 'SELECT tracking_id, short_description, urgency, Provider_id, status, category, impacted_account, type, created_date, AppVersion  from data WHERE  '.$resp2.'  urgency = "CRITICAL" AND created_date <"'.$date2.' 23:59:00" AND (resolution_date >"'.$date2.' 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected" AND (category = "ELIPSOS - NSK" OR category = "ELIPSOS - YMS" OR category = "CORM - YMS" OR category = "ELIPSOS - RMF") '.$plat1.' '.$type1.' order by month(resolution_date)' ;
