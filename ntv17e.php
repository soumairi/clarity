...
for($b=1; $b<= $nbre; $b++)
		...
		$sql50 = 'SELECT COUNT(*) as numb, AppVersion as app FROM data  WHERE  '.$resp2.'  ';
				...
				$sql1 .=' urgency = "Low" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI NOTIFICATION") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"';
				$sql2 = 'SELECT nom as name from mois where id = "'.$j.'" ';
				$sql3 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql4 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql5 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql6 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql7 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql8 .=' urgency = "Low" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql9 .=' urgency = "Low" AND type = "Incident"  AND (AppVersion= "Epic" OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " ) AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql10 .=' urgency = "Low" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				
				$sql21 .=' urgency = "Medium" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI NOTIFICATION") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql23 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql24 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql25 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql26 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql27 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql28 .=' urgency = "Medium" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql29 .=' urgency = "Medium" AND type = "Incident"  AND (AppVersion= "Epic" OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" " OR AppVersion="Network") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql30 .=' urgency = "Medium" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				
				$sql31 .=' urgency = "High" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI NOTIFICATION") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql33 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql34 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql35 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql36 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql37 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql38 .=' urgency = "High" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql39 .=' urgency = "High" AND type = "Incident"  AND (AppVersion= "Epic" OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql40 .=' urgency = "High" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				
				$sql41 .=' urgency = "Critical" AND type = "Incident"  AND (AppVersion = "Notification-EAI" OR AppVersion= "EAI NOTIFICATION") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql43 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "Standard notification"  AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql44 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "API" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql45 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYPAY" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql46 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYSALES" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql47 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYSPEED" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql48 .=' urgency = "Critical" AND type = "Incident"  AND AppVersion= "SKYREPORT" AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql49 .=' urgency = "Critical" AND type = "Incident"  AND (AppVersion= "Epic" OR AppVersion= "DATA BASE (ODS, OLTP)" OR AppVersion="SKYUTILITIES" OR AppVersion="AU UPDATE FILE" OR AppVersion="RFFE FILE" OR AppVersion=" ") AND category = "NTV - NSK" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
				$sql50 .=' urgency = "Critical" AND type = "Incident" AND category = "NTV - YMS" AND impacted_account = "Production"   AND created_date <"201'.$i.'-0'.$j.'-31 23:59:00" AND (resolution_date >"201'.$i.'-0'.$j.'-31 23:59:00" OR resolution_date ="0000-00-00 00:00:00 ") AND status <> "Rejected"' ;
...
$graph->title->SetFont(FF_ARIAL,FS_NORMAL,10);
			$graph->title->Set('NTV - NSK  APP REPARTITION IN PRODUCTION INCIDENTS STILL OPENED BETWEEN 201'.$annee.'-'.$mois.'-01 AND 201'.$i.'-'.$k  .'-31');
